...
async function getTeamNamesAndInning(page, team1Spot, team2Spot){
    ...
    while(1){
        ...
        while(playingGame){
            ...
            if(d1.getDate() == searchDate){
                ...
                var team1;
                var team2;
                [playing,team1,team2] = await getTeamNamesAndInning(page,
                    "//*[@id=\"gridWrapper\"]/div/div[1]/div/div/div/div[2]/div[1]/div[4]/div[1]/div[2]/div/a/div[2]/div[1]/div[1]",
                    "//*[@id=\"gridWrapper\"]/div/div[1]/div/div/div/div[2]/div[1]/div[4]/div[1]/div[3]/div/a/div[2]/div[1]/div[1]");
